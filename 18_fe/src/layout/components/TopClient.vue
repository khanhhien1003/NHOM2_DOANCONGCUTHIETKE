                ...
                <div class="search-bar flex-grow-1">
                    <div class="position-relative search-bar-box input-group w-100">
                        <input v-on:keyup.enter="timKiem()" v-model="noi_dung_tim" type="text"
                            ...
                            class="position-absolute top-50 search-show translate-middle-y"><i class="fa-solid fa-magnifying-glass"></i></span>
                ...
                <template v-if="auth">
                    ...
                    <div class="user-box dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a v-on:click="dangXuat()" class="dropdown-item"><i class="fa-solid fa-right-from-bracket"></i><span>Đăng
                                        Xuất</span></a>
                            </li>
                            <li><a v-on:click="dangXuatAll()" class="dropdown-item"><i class="fa-solid fa-right-from-bracket"></i><span>Đăng Xuất Tất
                                        Cả</span></a>
                            </li>
                        </ul>
                    </div>
